...
class cryptography:
    ...
    def decrypt(string):
        ...
        decoder_algorithm = {
            value: key for (key, value) in encryption_algorithm.items()
        }
        iterator = 0
        length = len(string)
            ...
            for a in range(len(item_list)):
                if item_list[a] * length == number1:
                    multiplication_list.append(
                        str(item_list[a]) + " X " + str(length) + " = " + str(number1)
                    )
        ...
        for i in range(len(item_list2)):
            ...
            for a in range(len(item_list2)):
                if item_list2[a] * length == number2:
                    multiplication_list2.append(
                        str(item_list2[a]) + " X " + str(length) + " = " + str(number2)
                    )
        ...
        for i in range(len(item_list)):
            ...
            for a in range(len(item_list)):
                if item_list[a] * length == number:
                    multiplication_list.append(
                        str(item_list[a]) + " X " + str(length) + " = " + str(number)
                    )
                    factor_list.append(item_list[a])
                else:
                    pass
    ...
    def LowestCommonMultiple(number1, number2):
        ...
        while lcm_not_found:
            if test_small_num < test_big_num:
                ...
                lcm.append(
                    "" + str(small_num) + " X " + str(i) + " is " + str(test_small_num)
                )
                lcm.append(
                    "" + str(big_num) + " X " + str(a) + " is " + str(test_small_num)
                )
                lcm_not_found = False
            elif test_small_num > test_big_num:
    ...
    def lowestForm(numerator, denominator):
        ...
        for i in range(num + 1):
            if i == 0 or i == 1:
                ...
                if (
                    len(str(lower1)) <= len(str(numerator)) + 2
                    and len(str(lower2)) <= len(str(denominator)) + 2
                ):
                    lower1 = str(lower1)
                    lower2 = str(lower2)
